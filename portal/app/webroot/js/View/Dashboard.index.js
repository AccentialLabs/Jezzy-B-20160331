...
$(document).ready(function () {
  ...
  alert("Data"+data+"Dia" + dia +  "---Dia da Semana: " + dias_semana[dia]); */
	...
	$.ajax({			
			type: "POST",			
			data:{},			
			url: "/jezzy-business/portal/dashboard/checkForSchedulesSolicitation",
			success: function(result){	
...
function addNewUser(){
	...
	var password = $("#emailSchedule").val();
	  ...
	  return $.ajax({
        method: "POST",
        url: "http://192.168.0.17/jezzy-business/portal/user/ajaxAddNewUser",
        data: {User: {
                name: name,
                email: email,
                password: password
...
function addNewSchedule(chooseDay) {
    ...
    return $.ajax({
        method: "POST",
        url: "http://192.168.0.17/jezzy-business/portal/schedule/ajaxAddSchedule",
        data: {Schedule: {
                schedulehour: time,
                serviceId: service,
                schedulePrice: price,
...
function removeScheduleSolicitation(indice){
	...
	$.ajax({			
			...
			url: "http://192.168.0.17/jezzy-business/portal/dashboard/writeFile",
			success: function(result){	
...
function aproveScheduleSolicitationDB(solicitationId, indice){
	...
	$.ajax({			
			...
			url: "http://192.168.0.17/jezzy-business/portal/dashboard/approveScheduleSolicitation",
			success: function(result){	
			//alert(result);
			$("#notification-item-"+indice).fadeOut(300);
		},
...
function removeScheduleSolicitationDB(solicitationId, indice){
	...
	$.ajax({			
			...
			url: "http://192.168.0.17/jezzy-business/portal/dashboard/reproveScheduleSolicitation",
			success: function(result){	
...
function suggestNewSchedule(indice, sid){
	...
	$.ajax({			
			...
			url: "http://192.168.0.17/jezzy-business/portal/dashboard/suggestNewSchedule",
			success: function(result){	
