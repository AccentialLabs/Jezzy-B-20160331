            ...
            <div id="collapseTwo" class="panel-collapse collapse out">
                <div class="panel-body">
					...
					<div class="col-md-12 help-icon">
							<img src="../portal/img/jezzy_icons/help-icon.png" />
					</div>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-inline marginTop10">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        ?>
                                        <input value="ACTIVE" name="fbkOffers" type="checkbox" <?php echo $checked; ?> > Compartilhar Nova oferta
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-inline marginTop10">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        ?>
                                        <input value="ACTIVE" name="gplusOffers" type="checkbox" <?php echo $checked; ?> > Compartilhar Nova oferta
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-inline marginTop10">
                                ...
                                <div class="checkbox">
                                    <label>
                                        ...
                                        ?>
                                        <input value="ACTIVE" name="twtOffers" type="checkbox" <?php echo $checked; ?> > Compartilhar Nova oferta
                                    </label>
                                </div>
                            </div>
                        </div>
